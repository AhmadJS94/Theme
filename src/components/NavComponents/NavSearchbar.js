...
export default function NavSearchbar() {
  return (
    <div className="flex flex-grow   relative bg-white  rounded-lg  ">
      ...
      />
      <button className="p-2 font-bold uppercase rounded-lg text-sm text-nav-primary border-l-2 border-nav-primary   hover:text-nav-secondary hover:bg-orange-400 transition duration-150">
        search
      </button>
    </div>
  );
